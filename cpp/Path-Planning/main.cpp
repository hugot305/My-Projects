        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            for ( int i = 0; i < sensor_fusion.size(); i++ ) {
                ...
                // Estimating car s position after executing previous trajectory.
            ...
            if (car_ahead)  {
              if ( !car_left && lane > 0 ) {
                // if there is a left available lane and no car in it.
                lane--; // Change lane left.
              } else if ( !car_righ && lane != 2 ){
                // if there is a right lane available and no car in it.
                lane++; // Change lane right.
              } else {
                speed_diff -= MAX_ACC;
              }
            } else {
              if ( lane != 1 ) { // if we're not on the center lane.
            ...
            // Creating coordinates to local car coordinates.
            ...
            // Output path points from previous path
            ...
            // Calculate distance and y position 30 meters ahead.
